...
state.ini2 <- c(A = X+10, B = Y)   # perturbed
...
Ccyclemodel <-function(t, state, parms) { 
  ...
  with (as.list(c(state, parms)),{
    ...
    dM2.SurfOcean.dt <- r12*M1.Atm + r32*M3.Marinbiota + r62*M6.SedRockOrg + r72*M7.VegSoil - r21*M2.SurfOcean - r23*M2.SurfOcean - r24*M2.SurfOcean
